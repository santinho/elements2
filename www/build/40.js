...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tab_page_6__ = __webpack_require__(1304);
...
var TabPage6 = (function () {
    ...
    TabPage6 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/santinho/GIT/elements3/elements2/src/pages/tab-page-6/tab-page-6.html"*/'<!---Settings TAB lauout-6-->\n\n<ion-content class="content-background-images">\n\n    <div background-size class="tab-6"\n\n    [ngStyle]="{\'background-image\': \'url(\' + params.backgroundImage + \')\'}" *ngIf=" params != null">\n\n        <div padding class="tab-decription">\n\n            <h2 tabs-title text-center>{{params.title}}</h2>\n\n            <p tabs-subtitle text-center>{{params.description}}</p>\n\n        </div>\n\n    </div>\n\n</ion-content>\n\n'/*ion-inline-end:"/home/santinho/GIT/elements3/elements2/src/pages/tab-page-6/tab-page-6.html"*/,
