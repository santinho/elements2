...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details_parallax__ = __webpack_require__(1282);
...
var ParallaxLayout2 = (function () {
    ...
    ParallaxLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'parallax-layout-2',template:/*ion-inline-start:"/home/santinho/GIT/elements3/elements2/src/components/parallax/layout-2/parallax.html"*/'<!--- Theme Parallax Product -->\n\n<!--- Header Big Image-->\n\n<ion-content elastic-header *ngIf="data != null">\n\n  <div background-size id="elastic-header"\n\n   [ngStyle]="{\'background-image\': \'url(\' + data.headerImage + \')\'}">\n\n    <div class="title">\n\n      <h2 parallax-subtitle>{{data.description}}</h2>\n\n      <h1 parallax-title>{{data.title}}</h1>\n\n    </div>\n\n    <div social>\n\n      <ion-icon (click)="onEvent(\'onLike\', data)">\n\n        <i class="icon {{data.iconLike}}"></i>\n\n      </ion-icon>\n\n      <ion-icon (click)="onEvent(\'onFavorite\', data)">\n\n        <i class="icon {{data.iconFavorite}}"></i>\n\n      </ion-icon>\n\n      <ion-icon (click)="onEvent(\'onShare\', data)">\n\n        <i class="icon {{data.iconShare}}"></i>\n\n      </ion-icon>\n\n    </div>\n\n  </div>\n\n  <!--Content-->\n\n  <ion-grid no-padding>\n\n    <ion-row>\n\n      <ion-col col-12>\n\n        <ion-list no-margin>\n\n          <ion-item *ngFor="let item of data.items;let i = index" (click)="onEvent(\'onItemClick\', item)">\n\n            <ion-avatar item-left>\n\n              <img src="{{item.image}}">\n\n            </ion-avatar>\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <h3 item-subtitle>{{item.description}}</h3>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n<!-- Fab Button -->\n\n<ion-fab #fab bottom right>\n\n  <button button-ion-fab ion-fab (click)="onEvent(\'onFab\', data, $event)">\n\n    <ion-icon name="add"></ion-icon>\n\n  </button>\n\n</ion-fab>\n\n'/*ion-inline-end:"/home/santinho/GIT/elements3/elements2/src/components/parallax/layout-2/parallax.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], ParallaxLayout2);
